...
{
    public partial class addContributorUserIdFk3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NipCode = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Listings_Contributors_ContributorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sealed = table.Column<bool>(type: "bit", nullable: true),
                    Premade = table.Column<bool>(type: "bit", nullable: true),
                    GlutenFree = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingTagsDb", x => x.ListingId);
                    table.ForeignKey(
                        name: "FK_ListingTagsDb_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributors_CompanyId",
                table: "Contributors",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Listings_ContributorId",
                table: "Listings",
